...
//#ifdef DEBUG
// THREAD_LOCAL uzoff_t bits_sent;   /* bit length of the compressed data */
//extern THREAD_LOCAL uzoff_t isize;      /* byte length of input file */
//#endif

//extern THREAD_LOCAL long block_start;       /* window offset of current block */
//extern THREAD_LOCAL unsigned near strstart; /* window offset of current string */
 ...
 * two sons).
 */
void IZDeflate::pqdownheap(ct_data near *tree, int k)
 ...
 */
void IZDeflate::scan_tree (ct_data near *tree, int max_code)
...
uzoff_t IZDeflate::flush_block(char *buf, ulg stored_len, int eof)
