...
std::vector<std::string> createFiles(const std::string &templ, int count, int maxSize, int minSize = 1, int flags = 0)
{
...
void zipUnzip(const std::string &dirName, const std::string &zipName, const std::string &outDir, int flags = 0)
{
	Fastzip fs;
	FUnzip fu;
	fs.junkPaths = true;
